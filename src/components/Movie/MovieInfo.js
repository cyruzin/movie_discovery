...
const MovieInfo = props => {
    const {
        ...
        overview, runtime, genres, videos
    } = props.data.results
    ...
    return (
        <Row>
            ...
            <Col lg={8} xs={24}>
                <img src={`${imgSize.w300}${poster_path}`} alt={title} />
            </Col>
            <Col lg={16} xs={24}>
                <h1>{title}</h1>
                <p>
                    <small>
                        ...
                        {videos.results.length > 0 &&
                            <span style={{ marginRight: 5 }}>
                                | <Icon type="play-circle" theme="outlined" /> <a href={`https://www.youtube.com/watch?v=${videos.results[0].key}`}
